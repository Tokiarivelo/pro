...
namespace PdfTemplateApp.WindowResizer
{
    /// <summary>
    ...
    public class WindowResizer
    {
        ...
        /// </summary>
        private readonly System.Windows.Window _mWindow;

        /// <summary>
        /// The last calculated available screen size
        /// </summary>
        private Rect _mScreenSize;

        /// <summary>
        /// How close to the edge the window has to be to be detected as at the edge of the screen
        /// </summary>
        private readonly int _mEdgeTolerance = 2;
        ...
        private void Window_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            var windowTopLeft = _mTransformToDevice.Transform(new Point(left, top));
            var windowBottomRight = _mTransformToDevice.Transform(new Point(right, bottom));
        ...
        private void WmGetMinMaxInfo(System.IntPtr hwnd, System.IntPtr lParam)
        {
            ...
            // Set min size
            var minSize = _mTransformToDevice.Transform(new Point(_mWindow.MinWidth, _mWindow.MinHeight));
